...
<section class="general-painting1 faq-cont">
  <div class="container">
    <div class="row">
      
      
          <div class="col-12 col-sm-12 col-md-8 col-lg-8 col-xl-8 inner-left">
          
          
      
  <div class="testimonials-txt">
            <p><i class="fas fa-quote-left"></i>  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam sagittis iaculis velit in tristique. Curabitur ac urna urna. Sed sollicitudin at nisi sed 
              accumsan. Donec ultrices vehicula orci. <i class="fas fa-quote-right"></i> </p>
            <strong> Nicholas Lane - CEO</strong>
          </div>
      ...
      <div class="testimonials-txt">
          ...
          <div class="testimonials-txt">
            ...
            <strong> Nicholas Lane - CEO</strong>
              ...
              <div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 inner-right"> 
              
              <div class="cate-list">
          <div class="cate-heading  "> What We Do </div>
          <div class="cate-list">
           <ul>
