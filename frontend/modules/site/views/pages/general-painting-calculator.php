...
<section class="royal-play-cont"> 
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                                                        ...
                                                        <table class="table table-bordered">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th scope="col" >Rate.sq.ft (in Rs.)</th>
                                                                    <!--<th colspan="2" scope="colgroup">Rate.sq.ft(in Rs.)</th>-->
                                                            ...
                                                            <tbody class="tbody1">
                                                                <tr class="show-row">
                                                                    <td scope="row" align="center"><div class="custom-control custom-radio">
                                                                            <!--<input type="radio" id="customRadio1" name="interior[0]['radio1']" class="custom-control-input rad-paint" value="fresh" data-val="0">-->
                                                                    ...
                                                                    <td><input name="interior[0]['appr-sqft1']" type="number" min="1" class="form-control int-appr-sqft"></td>
                                                                    <td class="paintclass">
                                                                    </td>
                                                                  ...
                                                                  <!--<input name="interior[0]['amount']" type="hidden" class="form-control general_amount1"></td>-->
                                                                    <td></td>
                                                                    <!--<td><div class="remove_row float-right"><i class=" fas fa-times-circle"></i></div></td>-->
                                                        ...
                                                        <table class="table table-bordered">
                                                            ...
                                                            <tbody class="tbody2">
                                                                <tr class="show-row2">
                                                                    ...
                                                                    <td><input name="exterior[0]['appr-sqft1']" type="number" min="0" class="form-control ext-appr-sqft"></td>
                                    ...
                                    <div class="form-group ">
                                        <div class="row mb-4">
                                            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 text-right total1">
                                                Total : <span style="display:none" class="rupees">  ₹</span>  <span class="badge badge-secondary gen-total"></span>
                    ...
                    <div class="modal-footer text-center">
                        ...
                        <button type="button" class="btn btn1" id="mailme-general"  onclick="openModal()">Mail me</button>
    ...
    <script type="text/html" id="form_tpl">
        <tr class="show-row">
            ...
            <td scope="row" align="center"><div class="custom-control custom-radio">
                   ...
                   <!--<input type="radio"  name="interior[<%= element.i %>]['radio1']" class="custom-control-input rad-paint" value="fresh" data-val="0">-->
                    <!--<label class="custom-control-label" for="customRadio1" ></label>-->
                </div></td>
            <td><div class="custom-control custom-radio">
            ...
            <td><input name="interior[<%= element.i %>]['appr-sqft1']" type="number" min="1" class="form-control int-appr-sqft"></td>
            <td class="paintclass">
            </td>
            <td><input name="interior[<%= element.i %>]['rate']" type="text" class="form-control fresh_price" readonly></td>
            <td><input name="interior[<%= element.i %>]['amount']" type="text" class="form-control general_amount" readonly> 
            <td><div class="remove_row float-right"><i class=" fas fa-times-circle"></i></div>
            </td>
        </tr>
    </script>
    <script type="text/html" id="form_tpl2">
        ...
        <tr class="show-row2">
            ...
            <td><input name="exterior[<%= element.i %>]['appr-sqft1']" type="number" min="0" class="form-control ext-appr-sqft"></td>
            <td class="ex-paintclass">
            </td>
            <!--<td class="text-center general-rate2"><b><span class="ex_price"></span></b>-->
...
//                });
   ...
   //Validation part---
            ...
            $(function() {
              $('body').on('keypress','.int-appr-sqft',function(event){
             ...
             $(function() {
              $('body').on('keypress','.ext-appr-sqft',function(event){
                    if (event.which != 8 && event.which != 0 && (event.which < 48 || event.which > 57)) {
                        return false;
                    }
                });
...
//                },
        ...
        function openModal(){   
            ...
            $('#mailme-general').attr('data-toggle', '');
            $('#mailme-general').attr('data-target', '');
           if(pr != ""){                
                $('#mailme-general').attr('data-toggle', 'modal');
                $('#mailme-general').attr('data-target', '#mailmepopup');
