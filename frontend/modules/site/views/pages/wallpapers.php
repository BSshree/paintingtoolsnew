...
<section class="general-painting1 designers-wall-cont">
  <div class="container">
    ...
    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 heading1" id="1">
        ...
        <span>₹60 Per .Sq.ft</span> </div>
        
        
         <div class="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-4 wallpaper-thumb">
            <p> <img src="themes/site_theme/images/wallpaper1.jpg"  alt=""></p>
            <p> Classy Wall Paper 1 </p>
          </div>
          <div class="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-4 wallpaper-thumb">
            <p> <img src="themes/site_theme/images/wallpaper2.jpg"  alt=""></p>
            <p> Classy Wall Paper 2 </p>
          </div>
          <div class="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-4 wallpaper-thumb">
            <p> <img src="themes/site_theme/images/wallpaper3.jpg"  alt=""></p>
            <p> Classy Wall Paper 3 </p>
          </div>
          <div class="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-4 wallpaper-thumb">
            <p> <img src="themes/site_theme/images/wallpaper4.jpg"  alt=""></p>
            <p> Classy Wall Paper 4 </p>
          </div>
          <div class="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-4 wallpaper-thumb">
            <p> <img src="themes/site_theme/images/wallpaper5.jpg"  alt=""></p>
            <p> Classy Wall Paper 5 </p>
          </div>
          <div class="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-4 wallpaper-thumb">
            <p> <img src="themes/site_theme/images/wallpaper6.jpg"  alt=""></p>
